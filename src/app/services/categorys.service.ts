...
export class CategorysService {
  ...
  putCate(id:number,data:createcategoryDtos):Observable<any>{
    return this.http.put<any>(`${environment.api}/Category/Put-Cate-`+id,data);
  }
  getcateid(id:number):Observable<any>{
    return this.http.get<categoryDtos>(`${environment.api}/Category/Get-cate-`+id);
  }
  deletecate(id:number):Observable<any>{
    return this.http.delete<any>(`${environment.api}/Category/Delete-Cate-` + id);
  }
